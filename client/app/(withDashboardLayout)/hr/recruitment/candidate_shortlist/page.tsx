...
const CandidateShortlist = () => {
  ...
  const [editData, setEditData]=useState<Partial<TCandidateShortList>>({id:"",name:"",candidateId:"",jobPosition:"",shortlistDate:"",interviewDate:""})
            ...
            return (
              ...
              >
                ...
                <HRInput
                  ...
                  defaultValue={editData[inputField?.key as keyof TCandidateShortList]||""}
                />
              </div>
            );
          })}
