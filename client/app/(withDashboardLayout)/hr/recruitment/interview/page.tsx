...
import { interView } from "../fakeData/fakeData";
...
const InterviewPage = () => {
  const [data, setData] = useState<TInterview[]>(interView);
  const [editData, setEditData]=useState<Partial<TInterview>>(
    {
        id: 0,
        name: "",
        candidateId: "",
  ...
  return (
    <div className="bg-white w-full min-h-screen rounded-2xl p-4 ">
        ...
        <SearchAndModal menuName={"Candidate Shortlist "} modalIsOpen={modalIsOpen} setIsOpen={setIsOpen} handleSearch={handleSearch} ></SearchAndModal>
            ...
            return (
              ...
              >
                ...
                <HRInput
                  ...
                  defaultValue={editData[inputField?.key as keyof TInterview]||""}
                />
              </div>
            );
          })}
