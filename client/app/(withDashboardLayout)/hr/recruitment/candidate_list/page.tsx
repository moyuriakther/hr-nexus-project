...
import SearchAndModal from "./components/SearchAndModal";
...
const CandidateList = () => {
  ...
  const [editData, setEditData] = useState<Partial<TCandidateList>>({
    id: "",
    name: "",
    candidateId: "",
    photograph: "",
            ...
            return (
              ...
              >
                ...
                <HRInput
                  ...
                  defaultValue={
                    editData[inputField?.key as keyof TCandidateList] || ""
                  }
                />
              </div>
            );
