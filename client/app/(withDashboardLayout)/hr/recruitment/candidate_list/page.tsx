...
import { candidates } from "../fakeData/fakeData";
...
const CandidateList = () => {
  ...
  const [editData, setEditData]=useState<Partial<TCandidateList>>({id:"",name:"",candidateId:"",photograph:"",ssn:"",phone:"",email:""})
  ...
  return (
    <div className="bg-white w-full min-h-screen rounded-2xl p-4 ">
        ...
        <SearchAndModal menuName={"Candidate List"} modalIsOpen={modalIsOpen} setIsOpen={setIsOpen} handleSearch={handleSearch} ></SearchAndModal>
