...
const CandidateData=({data, isLoading,handleEdit, setActionLoading, isActionLoading}:{isActionLoading:boolean, data:TCandidateList[],isLoading:boolean,handleEdit:any,setActionLoading:any})=>{
  ...
  if(isActionLoading){
    ...
    const handleDelete = async (id: string|number) => {
        ...
        const res = await updateCandidate({id:id, body:{...resData}});
        console.log(res);
...
// const CandidateData=({data,isLoading,handleEdit, setActionLoading}:{data:TCandidateList[],isLoading:boolean,handleEdit:any,setActionLoading:any})=>{
