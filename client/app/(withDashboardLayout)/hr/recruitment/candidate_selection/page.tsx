...
import SearchAndModal from "../component/SearchAndModalContant";
import {  selection } from "../fakeData/fakeData";
...
const CandidateSelectionPage = () => {
  const [data, setData] = useState<TCandidateSelection[]>(selection);
  const [editData, setEditData]=useState<Partial<TCandidateSelection>>({id:"",name:"",candidateId:"",position:"",selectionTerms:""})
  ...
  return (
    <div className="bg-white w-full min-h-screen rounded-2xl p-4 ">
        ...
        <SearchAndModal menuName={"Candidate Selection "} modalIsOpen={modalIsOpen} setIsOpen={setIsOpen} handleSearch={handleSearch} ></SearchAndModal>
            ...
            return (
              ...
              >
                ...
                <HRInput
                  ...
                  defaultValue={editData[inputField?.key as keyof TCandidateSelection]||""}
                />
              </div>
            );
          })}
